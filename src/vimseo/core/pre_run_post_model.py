    ...
    * ``POST_PROC_FAMILY``
    ...
    def __init__(
        ...
        **options,
        ...
        # TODO not desirable since it means that the run component should define
        # auto load grammar = False, and it prevents from using the run component directly
        # as a component in an IntegratedModel.
